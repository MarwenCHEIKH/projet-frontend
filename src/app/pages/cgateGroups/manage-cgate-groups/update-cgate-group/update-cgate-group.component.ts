...
@Component({
  selector: 'app-update-cgate-group',
  templateUrl: './update-cgate-group.component.html',
  styleUrls: ['./update-cgate-group.component.css'],
})
export class UpdateCgateGroupComponent {
  ...
  onDelete() {
    ...
    this.cgateGroupService
      .deleteCGateGroup(formDataObject)
      .pipe(
        tap((response) => {
          console.log('Response:', response.commandString);
        }),
