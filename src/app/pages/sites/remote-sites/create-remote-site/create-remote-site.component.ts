...
@Component({
  selector: 'app-create-remote-site',
  templateUrl: './create-remote-site.component.html',
  styleUrls: ['./create-remote-site.component.css'],
})
export class CreateRemoteSiteComponent {
  siteForm!: FormGroup;
  ...
  onSubmit() {
    const formDataObject = {
      ...
      partner_loc_alias: this.siteForm.value.partner_loc_alias,
    ...
    this.siteService
      .createRemoteSite(formDataObject)
      .pipe(
        tap((response) => {
