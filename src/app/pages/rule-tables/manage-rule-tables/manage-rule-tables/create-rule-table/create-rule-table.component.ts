...
@Component({
  selector: 'app-create-rule-table',
  templateUrl: './create-rule-table.component.html',
  styleUrls: ['./create-rule-table.component.css'],
})
export class CreateRuleTableComponent {
  ...
  submitFormData(formDataObject: any) {
    this.ruleTableService
      .createRuleTable(formDataObject)
      .pipe(
        tap((response) => {
